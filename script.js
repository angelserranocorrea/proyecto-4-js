...
function sendData() {
    ...
    function edit() {
        ...
        //RESUMEN FUNCIONAL: EL USUARIO PUEDE CORREGIR REGISTROS SIN TENER QUE REINGRESAR TODOS LOS CAMPOS

    }

    mostrarEnviado("El registro ha sido añadido exitosamente.");
...
function mostrarEnviado(mensaje) {
    ...
    messageContainer.appendChild(correcto);
